...
public class TestFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ratequiz = (RatingBar) view.findViewById(R.id.ratingBar_test);
        ...
        answer1 = (Button) view.findViewById(R.id.answer1_test);
        answer1.setOnClickListener(this);
        answer2 = (Button) view.findViewById(R.id.answer2_test);
        answer2.setOnClickListener(this);
        answer3 = (Button) view.findViewById(R.id.answer3_test);
        answer3.setOnClickListener(this);
        answer4 = (Button) view.findViewById(R.id.answer4_test);
        answer4.setOnClickListener(this);
        btnrate = (Button) view.findViewById(R.id.rate_button_test);
        btnrate.setOnClickListener(this);

        score = (TextView) view.findViewById(R.id.score_test);
        question = (TextView) view.findViewById(R.id.question_test);
        ...
        plus2 = (TextView)view.findViewById(R.id.plus2textView_test);
        ...
        mTimerView = (TimerView) view.findViewById(R.id.timer_test);
